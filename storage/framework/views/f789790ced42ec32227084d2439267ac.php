                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="p-5 rounded-2xl bg-slate-50 border border-slate-200">
                            ...
                            <div class="mt-4 p-3 rounded-xl bg-emerald-50 border border-emerald-200">
                                ...
                                <div class="space-y-2">
                                    <button type="button" @click="exchangeVoucher('10_percent', 50)" class="w-full py-2 bg-emerald-600 text-white text-xs font-bold rounded-lg hover:bg-emerald-700 transition-colors">
                                        Tukar 50 Poin (Diskon 10%)
                                    </button>
                                    <button type="button" @click="exchangeVoucher('15_percent', 75)" class="w-full py-2 bg-emerald-600 text-white text-xs font-bold rounded-lg hover:bg-emerald-700 transition-colors">
                                        Tukar 75 Poin (Diskon 15%)
                                    </button>
                                    <button type="button" @click="exchangeVoucher('20_percent', 100)" class="w-full py-2 bg-emerald-600 text-white text-xs font-bold rounded-lg hover:bg-emerald-700 transition-colors">
